...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    /*
     ...
     //        let favoriteVC = MyBagViewController()
     //
     //        favoriteVC.title = "Image"
     //        favoriteVC.tabBarItem = UITabBarItem(tabBarSystemItem: .contacts, tag: 0)
     //
     ...
     //
     //        tabBar.viewControllers = [createHomeNC(), createFavoriteNC()]
     //        return tabBar
     //    }
